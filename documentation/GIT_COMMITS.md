...
- `ADD: Experience Section Component`
- `ADD: ExpandableSection Component`
- `ADD: Education Data File`
- `ADD: Arrow Up Scroll Icon Component`
...
- `FIX: Resolve ExpandableSection Animation Issue on Mobile`
- `FIX: Correct TypeScript Type Definitions`
- `FIX: Fix Icon SVG Rendering on Safari`
- `FIX: Address TypeScript Compilation Errors`
- `FIX: Resolve CSS Variable Not Applying in Footer`
- `FIX: Fix ExpandableSection State Not Persisting`
...
- `REFACTOR: Rename Data Variables for Better Clarity`
- `REFACTOR: Extract ExpandableSection Logic into Reusable Component`
- `REFACTOR: Optimize Data Type Definitions`
- `REFACTOR: Simplify Section Component Structure`
...
- `UPDATE: Modify ExpandableSection Component Styling`
- `UPDATE: Update Skills Data Structure`
- `UPDATE: Enhance Samples Section with New Portfolio Items`
- `UPDATE: Update Typography CSS Variables`
- `UPDATE: Improve Footer Component Layout`
...
- `FIX: Resolve ExpandableSection Animation Issue on Mobile Devices`
- `ADD: Implement Experience Section with Lazy Loading`
- `REFACTOR: Extract ExpandableSection Logic into Reusable Component`
- `UPDATE: Enhance Samples Section with New Portfolio Items`
...
- `FIX: accordion` (not title case, too vague)
...
- Fix CSS Grid transition not working on iOS Safari
- Add fallback animation for older browsers
- Update expandable section container grid-template-rows logic
...
- **Section Components**: Summary, Skills, Knowledge, Experience, Education, Links, Samples
- **Layout Components**: Body, Header, Footer
- **Utility Components**: ExpandableSection, Sample
- **Icon Components**: ArrowUpIcon, ChevronDownIcon, GitHubIcon, LinkedInIcon

### Data Files

When committing data-related changes:

- Reference specific data files: skills.ts, knowledge.ts, experience.ts, education.ts, links.ts, samples.ts
- Mention if changes affect data structure, types, or validation
- Note if changes require data migration or type updates

### Styling Changes

When committing styling changes:

- Reference CSS variables when applicable
- Mention specific components or sections affected
- Note if changes affect responsive behavior or Tailwind utility classes
